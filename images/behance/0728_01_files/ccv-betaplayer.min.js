...
(function(e){var f=function(){function b(){}b.prototype.generateRandomString=function(a){for(var d="",c=0;c<a;c++)var b=Math.floor(61*Math.random()),d=d+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz".substring(b,b+1);return d};b.prototype.formatDoubleDigit=function(a){return 10>a?"0"+a:String(a)};b.prototype.formatTime=function(a){a=Math.round(a);var d=0,c=0;if(isFinite(a)&&0<a){for(;59<a;)c++,a-=60;for(;59<c;)d++,c-=60;return 0<d?d+":"+this.formatDoubleDigit(c)+":"+this.formatDoubleDigit(a):
c+":"+this.formatDoubleDigit(a)}return"0:00"};b.prototype.getExtension=function(a){var d=a.lastIndexOf(".");return a.substr(d+1,a.length)};b.prototype.getPrefix=function(a){return a.substring(0,a.indexOf("://"))};b.prototype.getFilename=function(a){return a.substr(a.lastIndexOf("/")+1)};b.prototype.reverse=function(a){return null===a?"":a.split("").reverse().join("")};b.prototype.reverseWords=function(a){return null===a?"":a.split(/\s+/).reverse().join(" ")};b.prototype.stripExtension=function(a){var d=
this.getExtension(a).length;return a.substr(0,a.length-(d+1))};b.prototype.getPart=function(a,d,c){a=a.split(d);return c>a.length?null:a[c]};b.prototype.insert=function(a,d,c){a=a.split(d);return a[0]+c+a[1]};return b}();e.StringUtilStatic=f})(com$adobe$ccv$util||(com$adobe$ccv$util={}));var StringUtil=new com$adobe$ccv$util.StringUtilStatic,StringUtil=StringUtil||null,com$adobe$ccv$app;
...
function(a){void 0===a&&(a=window);var d=a.navigator.userAgent.toLowerCase();return-1==d.indexOf("safari")||-1!=d.indexOf("chrome")||this.isChromeIOS(a)||this.isAndroid(a)?!1:!0};b.prototype.isIOS=function(a){void 0===a&&(a=window);var d=a.navigator.userAgent;a=/iPhone/i.test(d);var c=/iPad/i.test(d),d=/iPod/i.test(d);return a||c||d};b.prototype.isAndroid=function(a){void 0===a&&(a=window);return-1!=a.navigator.userAgent.toLowerCase().indexOf("android")?!0:!1};b.prototype.isChromeIOS=function(a){void 0===
...
function(a){void 0===a&&(a=window);return 0<a.navigator.userAgent.toLowerCase().indexOf("chrome")||this.isChromeIOS(a)};b.prototype.isChromeDesktop=function(a){void 0===a&&(a=window);var d=a.navigator.userAgent.toLowerCase();return this.isChrome(a)&&(0<d.indexOf("mac os x")||0<d.indexOf("windows nt"))&&!this.isChromeIOS(a)};b.prototype.isAndroidInternetBrowser=function(a){void 0===a&&(a=window);var d=a.navigator.userAgent;a=0<=d.indexOf("Android");d=(d=/WebKit\/([0-9]+)/.exec(d))&&0<d.length?parseInt(d[1],
10)||0:0;return a&&534>=d};b.prototype.ieVersion=function(a){void 0===a&&(a=window);var d=a.navigator.userAgent;if(this.isFireFox(a))return NaN;a=parseFloat((d.toLowerCase().match(/.*(?:rv|ie)[\/: ](.+?)([ \);]|$)/)||[])[1]);isNaN(a)&&-1!=d.indexOf("rv:11.0")&&(a=11);return a};b.prototype.isEdge=function(a){void 0===a&&(a=window);return-1<a.navigator.userAgent.indexOf("Edge")?!0:!1};b.prototype.isFlashAvailable=function(a){void 0===a&&(a=navigator.mimeTypes);var d=!1;try{new ActiveXObject("ShockwaveFlash.ShockwaveFlash")&&
(d=!0)}catch(c){a&&void 0!=a["application/x-shockwave-flash"]&&a["application/x-shockwave-flash"].enabledPlugin&&(d=!0)}return d};b.prototype.isAndroidWebView=function(a){void 0===a&&(a=window);return this.isAndroid(a)&&/version/.test(a.navigator.userAgent.toLowerCase())&&this.isChrome(a)};b.prototype.getAndroidVersion=function(a){void 0===a&&(a=window);a=a.navigator.userAgent.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i);var d,c;if(!a)return NaN;d=a[1]&&parseFloat(a[1]);c=a[2]&&parseFloat(a[2]);
return d&&c?parseFloat(a[1]+"."+a[2]):d?d:NaN};b.prototype.isUIWebView=function(a){void 0===a&&(a=window);return/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(a.navigator.userAgent)};b.prototype.isWebView=function(a){void 0===a&&(a=window);return this.isUIWebView(a)||this.isAndroidWebView(a)};b.prototype.noFullscreenButton=function(a){void 0===a&&(a=window);return this.isIOSDevice(a)&&this.isIPod(a)||this.isIE(a)&&11>this.ieVersion(a)};b.prototype.useMobileTheme=function(a){void 0===a&&(a=window);
return this.isMobileDevice(a)||this.isNexus7(a)||this.isSamsungDevice(a)};b.prototype.getOSXVersion=function(a){void 0===a&&(a=window);var d=NaN;a=a.navigator.userAgent.split("Mac OS X 10_");1<a.length&&(a=a[1].split("_"),1==a.length&&(a=a[0].split(")")),d=parseFloat(a[0]));return d};b.prototype.getIOSVersion=function(a){void 0===a&&(a=window);var d=NaN;if(a=a.navigator.userAgent.match(/OS (\d+)(?:_(\d+))?(?:_(\d+))*/i)){var c=a[1]&&parseFloat(a[1]),b=a[2]&&parseFloat(a[2]);c&&b?d=parseFloat(a[1]+
"."+a[2]):c&&(d=c)}return d};b._LOGTAG="DOMUtil";return b}();e.DOMUtilStatic=f})(com$adobe$ccv$util||(com$adobe$ccv$util={}));var DOMUtil=new com$adobe$ccv$util.DOMUtilStatic,DOMUtil=DOMUtil||null;
...
a.prototype.assert=function(a,c){for(var b=2;b<arguments.length;b++);};a.prototype.msIsIndependentlyComposed=function(a){return!1};a.prototype.clear=function(){};a.prototype.dir=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.warn=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.error=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.log=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.profileEnd=function(){};a.prototype.countReset=function(a){};
a.prototype.exception=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.markTimeline=function(a){};a.prototype.table=function(){for(var a=0;a<arguments.length;a++);};a.prototype.timeStamp=function(a){};a.prototype.timeline=function(a){};a.prototype.timelineEnd=function(a){};return a}();e.DummyConsole=f;var b=function(){function a(a,b){void 0===b&&(b=console);this.sendMessageTag=a;this._console=b}a.prototype.setCapacity=function(a){};a.prototype.clear=function(){};a.prototype.sendMessage=
function(a,b,g){return"["+a+"] "+b+": "+g};a.prototype.info=function(a,b){this._console.log(this.sendMessage("INFO",a,b))};a.prototype.debug=function(a,b){this._console.log(this.sendMessage("DEBUG",a,b))};a.prototype.warn=function(a,b){this._console.warn(this.sendMessage("WARN",a,b))};a.prototype.error=function(a,b){this._console.error(this.sendMessage("ERROR",a,b))};a.isAvailable=function(){return!!window.console};a.installDummyConsole=function(){window.console=new f};return a}();e.ConsoleLogger=
...
(function(e){var f=function(b){function a(d){d=b.call(this,d)||this;d.state="INIT";a.instance&&a.instance.shutdown();return a.instance=d}__extends(a,b);a.prototype.updateHtml=function(a,b,g){};a.prototype.embedPlayer=function(a,b,g){};a.prototype.shutdown=function(){};a.prototype.setPoster=function(a){};a.prototype.onSuccess=function(){if("SUCCESS"==this.state)LOGGING&&Log.info(a._LOGTAG,"_onSuccess: ignoring "+this.state);else if(LOGGING&&"INIT"!=this.state&&Log.info(a._LOGTAG,"_onSuccess: overruling "+
...
LOGGING&&Log.info(a._LOGTAG,"_onError: overruled by "+this.state)};a.prototype.validate=function(){for(var d=this.element,b=this.element.width(),g=this.element.height();0<d.length;){if(d.height()<g)return LOGGING&&Log.error(a._LOGTAG,"Invalid container height: id='"+d.attr("id")+"', class='"+d.attr("class")+"'. Need "+g+"px, have "+d.height()+"px."),!1;if(d.width()<b)return LOGGING&&Log.error(a._LOGTAG,"Invalid container width: id='"+d.attr("id")+"', class='"+d.attr("class")+"'. Need "+b+"px, have "+
...
(function(e){var f=function(b){function a(a){a=b.call(this,a)||this;a._LOGTAG="PlayPauseControl";a._$play.on("click",jQuery.proxy(a._onClick,a));return a}__extends(a,b);a.prototype.setupSelectors=function(){this._$play=this.$el.find(".playpause")};a.prototype._onClick=function(a){LOGGING&&Log.info(this._LOGTAG,"_onClick");a.stopImmediatePropagation();a.preventDefault();this.acceptsReplay()?this._onVideoReplay(a):this.isPlaying()?this._onVideoPause(a):this._onVideoPlay(a)};a.prototype._onVideoPlay=
...
(function(e){var f=function(b){function a(a){var c=b.call(this,a)||this;c._options=a;c._$volButton.on("click",jQuery.proxy(c._onVolumeClick,c));c.setVolume(a.volume);c.isSlideEnabled=!DOMUtil.isMobileDevice();if(c.isSlideEnabled)c._$volSlider.on("input",jQuery.proxy(c._onVolumeUpdate,c)).on("change",jQuery.proxy(c._onVolumeUpdate,c)).on("touchstart",jQuery.proxy(c._onVolumeBarTouch,c));else c._$range.addClass("hide");return c}__extends(a,b);a.prototype.initialize=function(a){b.prototype.initialize.call(this,
...
(function(e){var f=function(b){function a(a){a=b.call(this,a)||this;a._LOGTAG="ScreenControl";return a}__extends(a,b);a.prototype.initialize=function(a){b.prototype.initialize.call(this,a);this._isFullscreen=!1;return this.render()};a.prototype.setupSelectors=function(){var a=this.$el;this._$videoContainer=a.parents("#html5-video-holder");this._$controlScreen=a.find(".fullscreen");if(0<this._$controlScreen.length){this._$controlScreen.on("click",jQuery.proxy(this._onScreenClick,this));a=$("video");
1==a.length&&(LOGGING&&Log.info(this._LOGTAG,"setupSelector: registering webkitendfullscreen handler"),a.on("webkitendfullscreen",jQuery.proxy(this._onScreenClick,this)));var a=FullscreenUtil.requestPrefix(this._$controlScreen.get(0)),b=this;$(document).on(a,function(a){b._isFullscreen&&(LOGGING&&Log.info(b._LOGTAG,"setupSelectors: showNormalState"),b.showNormalState());b._isFullscreen=!b._isFullscreen})}};a.prototype.render=function(){return this};a.prototype._onScreenClick=function(a){LOGGING&&
Log.info(this._LOGTAG,"_onScreenClick");this._$controlScreen.hasClass("show-normal-screen")||"webkitendfullscreen"==a.type?this.showNormalState():this.showFullscreenState();return!1};a.prototype.setFullScreenHandler=function(a){this._handler=a};a.prototype.showNormalState=function(a){void 0===a&&(a=!0);LOGGING&&Log.info(this._LOGTAG,"showNormalState");this._$controlScreen.hasClass("show-normal-screen")&&(this._$controlScreen.removeClass("show-normal-screen"),this.$el.removeClass("full-screen-mode"),
a&&this._handler&&this._handler.exitFullscreen())};a.prototype.showPressEscMessage=function(){LOGGING&&Log.info(this._LOGTAG,"showPressEscMessage");this._pressEscMsg||(this._pressEscMsg=new com$adobe$ccv$app.Message("press-esc-message","","",com$adobe$ccv$localization.StringSet.getString("%press_esc"),""));var a=this;setTimeout(function(){var b=a._pressEscMsg.getMsgDiv(),g=DOMUtil.windowInnerHeight()/3-b.height()/2;b.css("margin-top",g.toString()+"px");a._pressEscMsg.showMsg(a._$videoContainer);b.fadeIn(4E3,
function(){b.fadeOut(3E3,function(){a._pressEscMsg.hideMsg()})})},1E3)};a.prototype.showFullscreenState=function(){LOGGING&&Log.info(this._LOGTAG,"showFullscreenState");this._$controlScreen.hasClass("show-normal-screen")||(this._$controlScreen.addClass("show-normal-screen"),this.$el.addClass("full-screen-mode"),this._handler&&this._handler.goFullscreen(),DOMUtil.isSafari()&&!DOMUtil.isIOSDevice()&&this.showPressEscMessage())};return a}(com$adobe$ccv$view.BaseView);e.ScreenControl=f})(com$adobe$ccv$controls||
...
this._loadingSpinner=this._videoSurface.find(".spinnerwrap");var k=-1E3,d=-1E3;b.find("#video-surface").on("mouseenter",function(a){k=d=-1E3}).on("mousedown",function(a){k=a.clientX;d=a.clientY}).on("mouseup",function(b){LOGGING&&-1E3==k&&Log.info(a._LOGTAG,"Mouse up w/o down, this is no click");-1E3!=k&&-1E3!=d&&(k=Math.abs(b.clientX-k),d=Math.abs(b.clientY-d),LOGGING&&20<=k&&Log.info(a._LOGTAG,"Mouse moved, this is no click: delta X="+k),LOGGING&&20<=d&&Log.info(a._LOGTAG,"Mouse moved, this is no click: delta Y="+
d),20>k&&20>d&&a._onPlayPauseVideoContainer(),k=d=-1E3)})};c.prototype.setupDefaults=function(){this._hasSources=!1;this._lastTime=0;this.hasEverPlayed=this._changedQuality=!1;this._autoHideControlsTimer=-1;this._lastClick=DOMUtil.now()};c.prototype.addSubscribers=function(){};c.prototype.render=function(){this.showLoader()._addVideoSubscribers()._addControlSubscribers()._initializeControls()._initializeVideo();return this};c.prototype._initializeVideo=function(){var a=this;if(DOMUtil.isIOSDevice()&&
...
function(a){}).on("progressDown",function(){LOGGING&&Log.info(a._LOGTAG,"progressDown");a.showLoader()}).on("progressUp",function(b){b=a.durationControl.getDuration();var d=a.progressControl.getPercent();b*=d;LOGGING&&Log.info(a._LOGTAG,"progressUp: updating to "+b);a._seek(b)});this._$volumeHolderNew.on("volumeUpdate",function(b){a._options.volume=b.percent;a.videoPlayer.setVolume(b.percent);a.saveSettings()});return this};c.prototype.changeVideo=function(a){this._changedQuality=!0;this.showLoader().setVideoSource(a).pause().destroy();
this.videoPlayer.load();this._gotDuration=!1;return this};c.prototype.pause=function(){var a=this;this.videoPlayer.pause();this.playPauseControl&&this.playPauseControl.showPauseState();this._playAfterExitFullscreen=!1;this.showControls();this._killAutoHideControls();this.isVideoCompletelyWatched||this.videoPlayer.getCurrentTime(function(d){a.sendDunamisEvent(b.PAUSE,Math.round(d))});return this};c.prototype.isValidOffsetParameter=function(a,b,d,c){return 1<a||1<d||1<b||0<c?!1:!0};c.prototype.calculateStartOffset=
function(a){var b=0,d=this._options.duration,c=(a.match(/m/g)||[]).length,e=(a.match(/s/g)||[]).length,s=(a.match(/h/g)||[]).length,f=(a.match(/[^msh0-9]/g)||[]).length,q=c+e+s,l=0,r=0,v=0;this.isValidOffsetParameter(c,e,s,f)&&(0==q?b=parseInt(a,10):(0!=s&&(a=a.split("h"),l=parseInt(a[0],10),a=a[1]),0!=c&&(c=a.split("m"),r=parseInt(c[0],10),a=c[1]),0!=e&&(e=a.split("s"),v=parseInt(e[0],10),a=e[1])),isFinite(v)&&isFinite(r)&&isFinite(l)&&""==a&&(b=3600*l+60*r+v));b>=Math.floor(d)&&(b=0);return b};
c.prototype.play=function(){var a=this;this.hideControls();if(this._dataLoaded||this._options.playVideoOnInit)return this.videoPlayer.play(),this.playPauseControl&&this.playPauseControl.showPlayState(),this.progressControl.enable(),this.videoHolder.hasClass("idle")?(this.hidePlayIcon(),this.sendDunamisEvent(b.START)):this.isVideoCompletelyWatched?(this.sendDunamisEvent(b.REPLAY),this.isVideoCompletelyWatched=!1):this.isPlayedAfterPause&&this.videoPlayer.getCurrentTime(function(d){a.sendDunamisEvent(b.RESUME,
Math.round(d))}),this};c.prototype.onMouseEnter=function(a){this.showControls()};c.prototype.onMouseLeave=function(a){this.hasEverPlayed&&this.playPauseControl.isPlaying()&&this.hideControls()};c.prototype.onMouseMove=function(a){DOMUtil.useMobileTheme()?this._delayAutoHideControls():this.showControls()};c.prototype._killAutoHideControls=function(){0<=this._autoHideControlsTimer&&(clearTimeout(this._autoHideControlsTimer),this._autoHideControlsTimer=-1)};c.prototype._delayAutoHideControls=function(a){void 0===
...
this,b=this.durationControl.getDuration();this.showControls();this._killAutoHideControls();this.videoPlayer.getCurrentTime(function(d){b&&d&&(0.1>b-d?(LOGGING&&Log.info(a._LOGTAG,"exitFullscreen: showing replay state"),a._playAfterExitFullscreen=!1,a.hasEverPlayed=!1,b=a.durationControl.getDuration(),a.progressControl.updateProgressBar(100),a.durationControl.updateCurrentTime(b),a.playPauseControl.showReplayState()):(a.progressControl.updateProgressBar(d/b),a.durationControl.updateCurrentTime(d)))})}};
c.prototype.changeSize=function(a,b){LOGGING&&Log.info(this._LOGTAG,"changeSize: "+a+", "+b);var d=this.spinner,c=this.$el.width(),e=this.$el.height(),c=a/2-c/2,e=b/2-e/2;LOGGING&&Log.info(this._LOGTAG,"changeSize spinner: "+c+", "+e+"("+d.width()+", "+d.height()+")");d.css("left",c.toString()+"px");d.css("top",e.toString()+"px");this.videoPlayer.changeSize(a,b);d=this._videoJSElement.offset().top+this._videoJSElement.outerHeight(!0)-this.controlbarHolder.outerHeight(!0);this.progressControl.changeSize(a,
b);this.controlbarHolder.width(this.videoPlayer.getSize().width);this.controlbarHolder.css("bottom","");this.controlbarHolder.css("top",d+"px");this.videoHolder.width(a);this.videoHolder.height(b)};c.prototype.getSize=function(){return{width:this.videoHolder.width(),height:this.videoHolder.height()}};c.prototype._updateSize=function(){var a=DOMUtil.windowInnerWidth(),b=DOMUtil.windowInnerHeight();LOGGING&&Log.info(this._LOGTAG,"_updateSize: using window w="+a+", h="+b);this.changeSize(a,b)};c.prototype._onResize=
...
b.prototype.getSample=function(a){return this.samples[a]};b.prototype.size=function(){return this.samples.length};return b}();e.SampleSizeTable=b;b=function(){function a(){this.syncSamples=[]}a.prototype.addTrackSyncSample=function(a){this.syncSamples.push(a)};a.prototype.getSyncSample=function(a){return this.syncSamples[a]};a.prototype.size=function(){return this.syncSamples.length};return a}();e.TrackSyncSampleTable=b;var d=function(){return function(a,b,d){this.startChunk=a;this.samplesPerChunk=
b;this.sampleDescID=d}}();e.SampleToChunk=d;b=function(){function a(){this.sampleToChunkTable=[]}a.prototype.addSampleToChunk=function(a,b,c){this.sampleToChunkTable.push(new d(a,b,c))};a.prototype.getSampleToChunk=function(a){return this.sampleToChunkTable[a]};a.prototype.size=function(){return this.sampleToChunkTable.length};return a}();e.SampleToChunkTable=b;b=function(){function a(b,d,c,e,s,g,f,l,r){this.a=b;this.b=d;this.u=c;this.c=e;this.d=s;this.v=g;this.x=f;this.y=l;this.w=r}a.prototype.toArray=
function(){return[this.a,this.b,this.u,this.c,this.d,this.v,this.x,this.y,this.w]};return a}();e.TransformationMatrix=b;var c=function(){return function(a,b,d,c,e){this.offset=a;this.size=b;this.startTime=d;this.duration=c;this.compositionTime=e}}();e.Sample=c;b=function(){function a(b){this.sampleIndex=b;this.samples=[]}a.prototype.addSample=function(a,b,d,e,s){this.samples.push(new c(a,b,d,e,s))};a.prototype.getStartSample=function(){return this.sampleIndex};a.prototype.concat=function(a){this.samples=
...
(function(e){function f(a){var b=a>>>16;a&=65535;return 0==a?b:b+a/65535}var b=function(){function a(){}a.prototype.parseHeaders=function(a){var b={},d,c,e;if(!a)return b;a.split("\n").forEach(function(a,h,f){e=a.indexOf(":");d=a.substr(0,e).trim().toLowerCase();c=a.substr(e+1).trim();d&&(b[d]=b[d]?b[d]+", "+c:c)});return b};a.prototype.supportsCORS=function(a){var b=$.Deferred();a=function(a,b){var d=new XMLHttpRequest;d.open(a,b,!0);return d}("GET",a);a.onload=function(){b.resolve(!0)};a.onerror=
function(){b.resolve(!1)};a.setRequestHeader("Range","bytes=0-40");a.responseType="arraybuffer";a.send();return b.promise()};a.prototype.http=function(a){var b=$.Deferred(),d=new XMLHttpRequest;d.open("GET",a.url,!0);d.responseType=a.responseType||"arraybuffer";d.setRequestHeader("Accept","*/*");var c=a.headers,e;if(c)for(e in a.headers)c.hasOwnProperty(e)&&d.setRequestHeader(e,c[e]);d.onload=function(a){b.resolve(d)};d.onerror=function(a){b.reject(d)};d.send();return b.promise()};return a}(),a=function(){function a(b){this._http=
b}a.prototype._greaterOrEqualFileSize=function(b,d,c){void 0===c&&(c=1);var e=$.Deferred();this._http.http({method:"GET",url:b,headers:{Range:"bytes="+d+"-"+(d+c).toString()},responseType:"arraybuffer"}).then(function(c){206==c.status?(LOGGING&&Log.info(a._LOGTAG,"File size "+d+" >= size of "+b),e.resolve(!0)):(LOGGING&&Log.info(a._LOGTAG,"File size "+d+" < size of "+b),e.resolve(!1))},function(){LOGGING&&Log.info(a._LOGTAG,"File size "+d+" < size of "+b);e.resolve(!1)});return e.promise()};a.prototype._getFileSize=
function(a,b,d,c){void 0===c&&(c=1E4);var e=this,f=$.Deferred(),g;if(0>=b)f.reject();else if(b>d)f.resolve(b);else if(b==d)f.resolve(d);else if(d-b<=c)f.resolve(b+Math.round((d-b)/2));else{var l=function(a,b,d){e._getFileSize(a,b,d).then(function(a){f.resolve(a)},function(){f.reject()})};g=b+d>>1;e._greaterOrEqualFileSize(a,g).then(function(c){c?l(a,g+1,d):l(a,b,g-1)},function(){f.reject()})}return f.promise()};a.prototype.getFileSize=function(a,b,d){void 0===b&&(b=0);void 0===d&&(d=5E6);var c=this,
e=$.Deferred();c._greaterOrEqualFileSize(a,d).then(function(f){(f?c.getFileSize(a,d,2*d):c._getFileSize(a,b,d)).then(function(a){e.resolve(a)},function(){e.reject()})},function(){e.reject()});return e.promise()};a._LOGTAG="FileSizeEvaluator";return a}(),d=function(){function b(a){this._http=a}b.prototype._calculateFileSize=function(d,c){var e=$.Deferred(),u=new a(this._http),f=c.videoTrackInfo,x=Math.floor(f.pixelWidth*f.pixelHeight*0.28)*c.duration,f=Math.floor(x-x/2),x=Math.ceil(x+x/2);u.getFileSize(d,
f,x).then(function(a){LOGGING&&Log.warn(b._LOGTAG,"File size for "+d+" is aprox. "+a);c.fileSize=a;e.resolve(c)},function(){e.reject()});return e.promise()};b.prototype.parse=function(a,b){var d=this,c=$.Deferred();d._http.supportsCORS(a).done(function(e){e?d._doParse(a).then(function(a){0<b&&(a.duration=b);c.resolve(a)},function(){c.reject()}):c.reject()});return c.promise()};b.prototype._doParse=function(a){function b(a,k){c.parseSegment(a,0,k).then(function(a){d.resolve(a)},function(a){d.reject()})}
var d=$.Deferred();this.url=a;this.cancelled=!1;this.totalFileSize=this.moovDataSize=0;this.moovFound=!1;this.findMoovProgress=30;this.processMoovProgress=50;this.analyzeProgress=20;this.mp4Asset=new e.MP4Asset;this.parseSegment.bind(this);this.parseType.bind(this);this.getData.bind(this);var c=this;this._http.http({method:"GET",url:this.url,headers:{Range:"bytes=0-"+(56).toString()},responseType:"arraybuffer"}).then(function(d){if(d=c._http.parseHeaders(d.getAllResponseHeaders())["content-range"])d=
d.substring(d.lastIndexOf("/")+1),c.totalFileSize=parseInt(d,10),c.mp4Asset.fileSize=c.totalFileSize;b(a,c.totalFileSize)},function(a){console.error("Request failed:"+a.toString())});return d.promise()};b.prototype.parseSegment=function(a,d,c){var e=this,f=$.Deferred();this.getNextTag(d).then(function(x){e.parseType(x.type,d+8,x.size-8).then(function(q){q?f.resolve(e.mp4Asset):0==c||d+x.size<c?(LOGGING&&Log.info(b._LOGTAG,"Found '"+x.type+"', looking for 'moov'..."),e.parseSegment(a,d+x.size,0<c?
c-x.size:0).then(function(a){f.resolve(a)},function(a){f.reject()})):(LOGGING&&Log.error(b._LOGTAG,"Can't locate 'moov' tag in "+a),f.reject())},function(a){f.reject()})},function(a){f.reject()});return f.promise()};b.prototype.getNextTag=function(a){var b=$.Deferred();this.getData(a,8).then(function(d){var c=new DataView(d.buffer);d=c.getUint32(0);c=c.getType(4);b.resolve({size:d,type:c,offset:a+8})},function(){b.reject()});return b.promise()};b.prototype.getNextTagInDataView=function(a,b){var d=
a.getUint32(b),c=a.getType(b+4);return{size:d,type:c,offset:b+8}};b.prototype.getNextTagOfTypeInDataView=function(a,b,d,c){for(var e=!1;!e;){var f=this.getNextTagInDataView(b,d);if(f.type==a)return f;f.size>=c&&(e=!0);d+=f.size;c-=f.size}};b.prototype.parseType=function(a,b,d){var c=$.Deferred();"moov"==a?(this.moovDataSize=d,this.parseMOOV(b,this.moovDataSize).then(function(){c.resolve(!0)},function(){c.reject()})):c.resolve(!1);return c.promise()};b.prototype.parseMOOV=function(a,b){var d,c,e=$.Deferred(),
f=this,g;this.getData(a,b).then(function(a){a=new DataView(a.buffer);for(var h=0,v=!1;!v;){var t=f.getNextTagInDataView(a,h);f.updateProcessMoovProgress(h);if("mvhd"==t.type)f.parseMVHD(a,h+8,t.size-8);else if("trak"==t.type){var y=f.parseTRAK(a,h+8,t.size-8);y.headerInfo.audio?c=y:y.headerInfo.video&&(d=y)}h+=t.size;b-=t.size;0>=b&&(v=!0)}g=f.analyze(d,c);e.resolve(g)},function(){e.reject()});return e.promise()};b.prototype.parseMVHD=function(a,b,d){var c=b,e=a.getUint8(c),c=c+1+3;0==e?(b=a.getUint32(c),
c+=4):(b=a.getUint64(c),c+=8);0==e?(d=a.getUint32(c),c+=4):(d=a.getUint64(c),c+=8);var f=a.getUint32(c),c=c+4,c=0==e?a.getUint32(c):a.getUint64(c);a.getUint32(20);a.getUint16(24);this.mp4Asset.timeScale=f;this.mp4Asset.duration=c;this.mp4Asset.creationTime=b;this.mp4Asset.modificationTime=d;return this.mp4Asset};b.prototype.parseMDHD=function(a,b){var d={},c=a.getUint8(b);b=b+1+3;0==c?(d.creationTime=a.getUint32(b),b+=4):(d.creationTime=a.getUint64(b),b+=8);0==c?(d.modificationTime=a.getUint32(b),
b+=4):(d.modificationTime=a.getUint64(b),b+=8);d.timeScale=a.getUint32(b);b+=4;d.duration=0==c?a.getUint32(b):a.getUint64(b);return d};b.prototype.parseTKHD=function(a,b){var d={},c=a.getUint8(b);b+=1;var s=a.getUint32(b);if(1==(s>>>8&1)){b+=3;0==c?(d.creationTime=a.getUint32(b),b+=4):(d.creationTime=a.getUint64(b),b+=8);0==c?(d.modificationTime=a.getUint32(b),b+=4):(d.modificationTime=a.getUint64(b),b+=8);d.index=a.getUint32(b);b=b+4+4;0==c?(d.duration=a.getUint32(b),b+=4):(d.duration=a.getUint64(b),
b+=8);b+=8;d.videoLayer=a.getUint16(b);b+=2;b+=2;d.volume=a.getUint16(b);b+=2;b+=2;c=f(a.getUint32(b));b+=4;s=f(a.getUint32(b));b+=4;b+=4;var g=f(a.getUint32(b));b+=4;var q=f(a.getUint32(b));b+=4;b+=4;var l=f(a.getUint32(b));b+=4;var r=f(a.getUint32(b));b+=4;b+=4;d.matrix=new e.TransformationMatrix(c,s,0,g,q,0,l,r,1);d.width=f(a.getUint32(b));b+=4;d.height=f(a.getUint32(b))}return d};b.prototype.parseTRAK=function(a,b,d){for(var c={},e=!1,f=!1,g,l,r,v,t=!1;!t;){var y=this.getNextTagInDataView(a,b);
this.updateProcessMoovProgress(b);"tkhd"==y.type&&(g=this.parseTKHD(a,b+8),c.headerInfo=g);if("mdia"==y.type)for(var p=!1,w=b+8,n=y.size-8;!p;){var D=this.getNextTagInDataView(a,w);this.updateProcessMoovProgress(w);if("hdlr"==D.type){var C=a.getType(w+16);"vide"==C?f=!0:"soun"==C&&(e=!0)}else if("mdhd"==D.type)v=this.parseMDHD(a,w+8),r=v.timeScale,v=v.duration;else if("minf"==D.type){var B=this.getNextTagOfTypeInDataView("stbl",a,w+8,D.size-8);if(void 0!=B)for(var C=!1,A=B.offset,B=B.size-8;!C;){var z=
this.getNextTagInDataView(a,A);this.updateProcessMoovProgress(A);if("stsd"==z.type||"stco"==z.type||"stts"==z.type||"stsc"==z.type||"stsz"==z.type||"stss"==z.type||"ctts"==z.type)"stsd"==z.type?l=this.parseSTSD(a,A+8):"stco"==z.type?c.chunkTable=this.parseSTCO(a,A+8):"stts"==z.type?c.durationTable=this.parseSTTS(a,A+8):"stss"==z.type?c.syncSampleTable=this.parseSTSS(a,A+8):"stsc"==z.type?c.sampleToChunkTable=this.parseSTSC(a,A+8):"stsz"==z.type?c.sampleTable=this.parseSTSZ(a,A+8):"ctts"==z.type&&
(c.compositionTimeToSampleTimeTable=this.parseCTTS(a,A+8,z.size-8));A+=z.size;B-=z.size;0>=B&&(C=!0)}}w+=D.size;n-=D.size;0>=n&&(p=!0)}b+=y.size;d-=y.size;0>=d&&(t=!0)}void 0!=g&&void 0!=l&&(g.format=l.format,g.timeScale=r,g.durationInTrackTimeScale=v,f?(g.video=!0,g.pixelWidth=l.pixelWidth,g.pixelHeight=l.pixelHeight,g.pixelDepth=l.pixelDepth,g.resolutionWidth=l.resolutionWidth,g.resolutionHeight=l.resolutionHeight,g.avcC=l.avcC,g.pasp=l.pasp):void 0!=e&&(g.audio=!0,g.channels=l.channels,g.sampleSize=
l.sampleSize,g.sampleRate=l.sampleRate,g.esds=l.esds));return c};b.prototype.parseCTTS=function(a,b,d){d=[];b+=4;var c=a.getUint32(b);b+=4;for(var e=0;e<c;e++){var f=a.getUint32(b);b+=4;var g=a.getUint32(b);b+=4;for(var l=0;l<f;l++)d.push(g)}return d};b.prototype.parseSTSD=function(a,b){var d=b,c={},e,g;b+=4;for(var q=a.getUint32(b),l=b+=4,r=0;r<q;r++){var v=a.getUint32(b);b+=4;e=a.getType(b);b+=4;if("avc1"==e)for(c.type="video",c.format="avc1",b+=24,c.pixelWidth=a.getUint16(b),b+=2,c.pixelHeight=
a.getUint16(b),b+=2,c.resolutionWidth=f(a.getUint32(b)),b+=4,c.resolutionHeight=f(a.getUint32(b)),b+=4,b+=38,c.pixelDepth=a.getUint16(b),b+=2,b+=2;b<d+v;)e=a.getUint32(b),g=a.getType(b+4),"avcC"==g?c.avcC=this.parseAVCC(a,b+8,e-8):"pasp"==g&&(c.pasp=this.parsePASP(a,b+8,e-8)),b+=e;else"mp4a"==e?(c.type="audio",c.format="mp4a",b+=16,c.channels=a.getUint16(b),b+=2,c.sampleSize=a.getUint16(b),b+=2,b+=4,c.sampleRate=f(a.getUint32(b)),b+=4,b<d+v&&(e=a.getUint32(b),g=a.getType(b+4),"esds"==g&&(c.esds=this.parseESDS(a,
b+8,e-8)))):console.error("UNKNOWN MEDIA FORMAT!!!!!!! "+e);l=b=l+v+4}return c};b.prototype.parseAVCC=function(a,b,d){var c=b,e={};b+=1;e.profile=a.getUint8(b);b+=1;e.compatibleProfiles=a.getUint8(b);b+=1;e.level=a.getUint8(b);b+=1;var f=e.profile.toString(16);"0"==f&&(f="00");var g=e.compatibleProfiles.toString(16);"0"==g&&(g="00");var l=e.level.toString(16);"0"==l&&(l="00");e.codec="avc1."+f+g+l;e.nalLen=a.getUint8(b)&3;b+=1;e.nonOfSPS=a.getUint8(b);b+=1;e.spsLength=a.getUint16(b);b+=2;e.sps=[];
for(f=0;f<e.spsLength;f++)g=a.getUint8(b),b+=1,e.sps.push(g);e.nonOfPPS=a.getUint8(b);b+=1;e.ppsLength=a.getUint16(b);b+=2;e.pps=[];for(f=0;f<e.ppsLength;f++)g=a.getUint8(b),b+=1,e.pps.push(g);e.raw=[];for(b=0;b<d;b++)e.raw.push(a.getUint8(c+b));return e};b.prototype.parseESDS=function(a,b,d){for(var c={codec:"mp4a.40.2",raw:[]},e=0;e<d;e++)c.raw.push(a.getUint8(b+e));return c};b.prototype.parsePASP=function(a,b,d){for(var c={raw:[]},e=0;e<d;e++)c.raw.push(a.getUint8(b+e));return c};b.prototype.parseSTCO=
function(a,b){b+=4;var d=a.getUint32(b);b+=4;for(var c=new e.ChunkTable,f=0;f<d;f++){var g=a.getUint32(b);b+=4;c.addChunk(g)}return c};b.prototype.parseSTTS=function(a,b){var d=[];b+=4;var c=a.getUint32(b);b+=4;for(var e=0;e<c;e++){var f=a.getUint32(b);b+=4;var g=a.getUint32(b);b+=4;for(var l=0;l<f;l++)d.push(g)}return d};b.prototype.parseSTSS=function(a,b){var d=new e.TrackSyncSampleTable;b+=4;for(var c=a.getUint32(b),f=b+4,g=0;g<c;g++)d.addTrackSyncSample(a.getUint32(f)),f+=4;return d};b.prototype.parseSTSC=
function(a,b){var d=new e.SampleToChunkTable;b+=4;for(var c=a.getUint32(b),f=b+4,g=0;g<c;g++){var q=a.getUint32(f),f=f+4,l=a.getUint32(f),f=f+4,r=a.getUint32(f),f=f+4;d.addSampleToChunk(q,l,r)}return d};b.prototype.parseSTSZ=function(a,b){var d=new e.SampleSizeTable;b+=4;var c=a.getUint32(b);b+=4;var f=a.getUint32(b);b+=4;var g;if(0==c)for(c=b,g=0;g<f;g++)d.addSampleOfSize(a.getUint32(c)),c+=4;else for(g=0;g<f;g++)d.addSampleOfSize(c);return d};b.prototype.analyze=function(a,b){this.updateAnalyzeProgress(0);
var d;if(void 0!=a){var c={};d=a.headerInfo;c.videoFormat=d.format;c.videoWidth=d.width;c.videoHeight=d.height;c.pixelWidth=d.pixelWidth;c.pixelHeight=d.pixelHeight;c.pixelDepth=d.pixelDepth;c.resolutionWidth=d.resolutionWidth;c.resolutionHeight=d.resolutionHeight;c.duration=d.duration;c.durationInTrackTimeScale=d.durationInTrackTimeScale;c.transformationMatrix=d.matrix;c.timeScale=d.timeScale;c.codec=d.avcC.codec;c.avcC=d.avcC;c.pasp=d.pasp;c.totalFrames=a.durationTable.length;c.sampleGroupTable=
this.generateSampleGroupTable(a,!0);this.mp4Asset.videoTrackInfo=c}this.updateAnalyzeProgress(50);void 0!=b&&(c={},d=b.headerInfo,c.codec=d.esds.codec,c.audioFormat=d.format,c.audioChannels=d.channels,c.audioSampleSize=d.sampleSize,c.audioSampleRate=d.sampleRate,c.timeScale=d.timeScale,c.totalFrames=b.durationTable.length,c.duration=d.duration,c.volume=d.volume,c.durationInTrackTimeScale=d.durationInTrackTimeScale,c.esds=d.esds,c.sampleGroupTable=this.generateSampleGroupTable(b,!1),this.mp4Asset.audioTrackInfo=
c);this.updateAnalyzeProgress(100);return this.mp4Asset};b.prototype.generateSampleGroupTable=function(a,b){var c=new e.SampleGroupTable,d=a.durationTable.length,f=a.headerInfo.timeScale,g=a.headerInfo.durationInTrackTimeScale/f,q=a.sampleToChunkTable,l=a.chunkTable,r=a.durationTable,v=a.sampleTable,t=a.syncSampleTable,y=a.compositionTimeToSampleTimeTable,p=0,w=0,n;if(void 0!=y)for(p=0;p<y.length;p++)n=v.getSample(p),n.compositionTime=y[p];for(var y=q.size(),D=l.size(),C=0,p=0;p<y;p++){n=q.getSampleToChunk(p);
...
function(a){function b(a,d){var f=c.getTechOrder(a,d);c._createPlayerForElement(a,f);e.resolve(c)}var c=this,e=$.Deferred(),f;(f=this.getWWWHost(a))&&f.length&&(f+="/info");a.find("video").attr("display","block");window.ccv$serverData&&window.ccv$serverData.minframeHeight&&window.ccv$serverData.minframeWidth&&window.ccv$serverData.duration?(c.config.setConfigValue("minframeWidth",window.ccv$serverData.minframeWidth.toString()),c.config.setConfigValue("minframeHeight",window.ccv$serverData.minframeHeight.toString()),
b(a,window.ccv$serverData.duration)):f?this.getAuthorizedJSON(f).then(function(d){c.config.setConfigValue("minframeWidth",d.minframe.width.toString());c.config.setConfigValue("minframeHeight",d.minframe.height.toString());b(a,d.duration)}).fail(function(){LOGGING&&Log.error(d._LOGTAG,"Failed to retrieve info"+f);e.reject()}):b(a,this.getDuration(a));return e.promise()};d.prototype.getWWWHost=function(a){return a.find("video").first().data("wwwhost")};d.prototype.getGatewayApiKeyFromUrlQueryParams=
function(b){var c="";if(b&&b.includes(a.WWW_GATEWAY_API_KEY_QUERY)){b=b.substring(b.indexOf("?")+1);var d="",e=0;for(b=b.split("&");e<b.length;e++)if(d=b[e],d=d.split("="),1<d.length&&d[0]===a.WWW_GATEWAY_API_KEY_QUERY){c=d[1];break}}return c};d.prototype.createWrapper=function(a){var b=$("<div></div>");b.addClass("html5-video-wrapper");b.data("status",a.data("status")||"ok");b.data("rootdir",a.data("rootdir")||"/");var c,d,e=a.data();for(c in e)e.hasOwnProperty(c)&&(d=e[c],b.data(c,d),a.removeData(c));
c=$("<div></div>");c.attr("id","html5-video-holder");c.append(a);a.addClass("video-js");a.data("account","2869242976001");a.data("player","7e1cd48d-2db9-4901-acc5-63e50cdec4ca");a.data("embed","default");a.data("id","");a=$("<div></div>");a.attr("id","video-surface");DOMUtil.isAndroidInternetBrowser()&&(a.css("background-color","transparent"),$("meta[name=viewport]").attr("content","minimum-scale=1.0,maximum-scale=1.0,user-scalable=yes"));c.append(a);d=$("<div></div>");d.attr("id","videocontrols");
c.append(d);DOMUtil.isIPhone()||(d=$('<div class="spinnerwrap" id="spinner-control"> <div class="spinner spinner--indeterminate spinner--overBackground"><div class="spinner-track"></div><div class="spinner-fills"><div class="spinner-fillMask1"><div class="spinner-fillSubMask1"><div class="spinner-fill"></div></div></div><div class="spinner-fillMask2"><div class="spinner-fillSubMask2"><div class="spinner-fill"></div></div></div></div></div></div>'),a.append(d));a=$("<div></div>");a.addClass("startcover");
a.attr("id","startcover");c.append(a);a=$("<div></div>");a.attr("id","html5-video-poster");c.append(a);a=$("<div></div>");a.attr("id","messages");a.addClass("message-container");c.append(a);b.append(c);return b};d.prototype.attachToVideoElement=function(a){var b=$(a);a=b.parent();b=this.createWrapper(b);a.append(b);return this.loadPlayer(b)};d.prototype.updateSource=function(b){if(DOMUtil.isSafari()||DOMUtil.isIOS()||DOMUtil.isFireFoxAndroid()){var c=b.find("video").first();if(c&&(c=c.find("source[type='application/x-mpegURL']"))&&
0<c.length){var d=c[0].src,e=d.indexOf("?"),f={};f[a.WWW_PROXY_PLAYBACK_QUERY]=d.substring(0,e);f[a.WWW_PROXY_TOKEN_QUERY]=d.substr(e+1);d=this.getWWWHost(b);b=document.createElement("a");b.setAttribute("href",d);(d=this.getGatewayApiKeyFromUrlQueryParams(b.search))&&(f[a.WWW_GATEWAY_API_KEY_QUERY]=d);f=jQuery.param(f);c[0].src=b.protocol+"//"+b.hostname+(b.port?":"+b.port:"")+a.WWW_API_MANIFEST_ENDPOINT+"?"+f}}};d.prototype.loadPlayer=function(a){this.createConfiguration(a);this.updateSource(a);
var c=this.config.isConfigOptionEnabled("lazyLoading"),d=a.find("video");d.attr("display","none");if(c){var e=this,c=$(".html5-video-wrapper");d.attr("preload","none");var g=$.Deferred(),d=this.config.getConfigValue("poster");$("#html5-video-poster").css("background-image","url("+d+")");$("#html5-video-holder").addClass("idle");0==e.config.getConfigValue("clientappname").length||e._loadEventSent||(e._loadEventSent=!0,VideoProperties.setProperties(a,e.config),e.dunamisEventSender=f.getInstance(e.config),
e.dunamisEventSender.sendEvent(DunamisEventFactory.getEvent(b.RENDER)));c.on("click",function(b){b.preventDefault();e.attachTo(a).done(function(a){g.resolve(a)}).fail(function(){g.reject()})});return g.promise()}d.attr("preload","auto");return this.attachTo(a)};d.prototype.attachTo=function(a){var c=$.Deferred(),e=this;this._attached||!a.length?c.reject():(e._attached=!0,LOGGING&&com$adobe$ccv$logging.ConsoleLogger.isAvailable()&&Log.addLogger(new ConsoleLogger(d._LOGTAG)),LoadTypekit.run(),document.title=
"Creative Cloud Player "+com$adobe$ccv$app.Version.getVersion(),e.processPage(a).done(function(d){e._loadEventSent||(e._loadEventSent=!0,VideoProperties.setProperties(a,e.config),e.dunamisEventSender=f.getInstance(e.config),e.dunamisEventSender.sendEvent(DunamisEventFactory.getEvent(b.RENDER)));c.resolve(d)}).fail(function(){c.reject()}));return c.promise()};d.prototype.onSizeChange=function(a){this._cloudPlayer&&this._cloudPlayer.changeSize(DOMUtil.windowInnerWidth(),DOMUtil.windowInnerHeight())};
d._LOGTAG="VideoJSPlayerApp";return d}(com$adobe$ccv$app.PlayerApp);e.VideoJSPlayerApp=d})(com$adobe$ccv$videojs||(com$adobe$ccv$videojs={}));var DUNAMIS_STAGE="stage",DUNAMIS_PROD="prod",CCV_TO_DUNAMIS_ENV_MAP={dev:DUNAMIS_STAGE,stage:DUNAMIS_STAGE,prod:DUNAMIS_PROD},VISITOR_ORG_ID="44FD596D5707FFAC7F000101@AdobeOrg",SOURCE_CLIENT_ID="CreativeCloudSDK";
